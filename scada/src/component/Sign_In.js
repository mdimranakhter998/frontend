          ...
          <Navbar_r/>
                ...
                <Alert show={show} variant='danger'>{alert}</Alert>  
                    ...
                    <Button variant="Light" style={{ float: 'right' }} size="sm">
                        <Nav.Link as={NavLink} onClick={closeTab} to="/check_forgetpassword">Forgot Password ?</Nav.Link>
                    </Button>
                    <br /><br />

                    New with us??
                    <Button variant="link" style={{ "text-decoration": 'none' }} className="m-1" size="sm">
                        <Nav.Link as={NavLink} onClick={closeTab} to="/sign_up">Register</Nav.Link>
